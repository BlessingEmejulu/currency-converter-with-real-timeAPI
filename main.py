...
# Frames
top_frame = Frame(window, width=300, height=60, bg=GREEN_COLOR)
...
app_name_label = Label(top_frame, image=icon_image, compound=LEFT, text="Currency Converter", height=3, padx=13, pady=30, anchor=CENTER, font=('Arial 16 bold'), bg=GREEN_COLOR, fg=WHITE_COLOR)
...
convert_button = Button(main_frame, text="Convert", width=19, padx=5,
                        height=1, bg=GREEN_COLOR, fg=WHITE_COLOR, font=('Ivy 12 bold'), command=convert)
